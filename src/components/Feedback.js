            ...
            <form method="post">
               ...
               <div className="row">
                    <div className="col-md-6">
                        ...
                        <div className="form-group">
                            <input type="submit" name="btnSubmit" className="btnContact" value="Submit Feedback" />
                        </div>
                    </div>
                    <div className="col-md-6">
                        <div className="form-group">
                            <textarea name="txtMsg" className="form-control text" placeholder="Your Message *"></textarea>
                        </div>
                    </div>
                </div>
            </form>
